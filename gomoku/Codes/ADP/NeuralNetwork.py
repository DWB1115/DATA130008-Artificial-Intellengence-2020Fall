"""
The Neural Network part of gomoku player
Create by Zhang, 6 Jan 2021
"""
...
class FullConnectedLayer(object):
    ...
    def update(self, lr, mode=0):
        ...
        # mod=0指SGD模式，即随机梯度下降
        # mod=1指batch模式，即批量梯度下降, 当选取batch为整个训练集时，为BGD模式，即批量梯度下降
        if mode == 0:
...
if __name__ == '__main__':
    ...
    data = np.array([[random.random()] for i in range(1000)])
